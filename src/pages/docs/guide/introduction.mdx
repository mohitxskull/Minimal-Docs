...
For more information on how to use charts in Minimal Docs, check out the [Charts documentation](/docs/components/charts).
...
[Custom Components documentation](/docs/components/custom).
